...
import com.example.lamba.Entity.Lambde;
...
public class Lambda {
    static List<Lambde> list1 = Arrays.asList(new Lambde("Nguyen Van A", true, 12.0),
            new Lambde("Nguyen Van B", false, 10.2),
            new Lambde("Tran Thi C", false, 10.0));
    ...
    private static void demo4() {
        ...
        Lambde list2 = list1.stream().reduce(list1.get(0), (student, student2) -> {
